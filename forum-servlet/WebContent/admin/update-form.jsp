		...
		<div class="dash-app">
			...
			<main class="dash-content">
				<div class="container-fluid">
					<h2 class="dash-title">Update /${thread.thread_name}/ Threads</h2>
					<div class="row">
						<div class="container">
							<div class="card spur-card">
								...
								<c:set var="thread" value="${requestScope.thread}"/>
									<form method="get" action="add-update-thread">
										<input name="thread_id" type="hidden" value="${thread.thread_id}">
										<div class="form-group">
											<label for="inputName">Name Thread</label> 
											<input name="thread-name" type="text" class="form-control" id="inputName" value="${thread.thread_name}">
										</div>
										<div class="form-group">
											<label for="inputDesc">Description</label>
											<textarea name="description" class="form-control" id="inputDesc" rows="3">${thread.description }</textarea>
										</div>
											...
											<div class="d-flex ">
												<div>
													<label class="button" for="customFile2">Choose
														...
														onchange="displaySelectedImage(event, 'selectedAvatar')" value="${thread.img}"/>
												</div>
											</div>
											</div>
											<div>
